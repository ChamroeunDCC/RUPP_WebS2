        ...
        <div class="d-flex justify-content-center mt-5 text-center">
            <div class="card text" style="width: 18rem;">
                ...
                <div class="card-body">
                    ...
                    <input type="hidden" name="price" value="{{ $foodData->price }}">
